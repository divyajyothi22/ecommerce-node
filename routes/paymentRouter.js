...
const { updatedPayment } = require("../controller/paymentController");
// const { allProduct, updateProduct, deleteProduct, getProduct, addProduct } = require("../controller/productController");
...
productRouter.patch("/update/:productId", async (req,res) => {
    try {
        const response = await updatedPayment(req);
        res.send(response);
        res.end();
...
productRouter.get("/:productId", async (req,res) => {
    try {
        const response = await getPayment(req);
        res.send(response);
        res.end();
